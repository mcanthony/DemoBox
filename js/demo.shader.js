;(function(Demo, window, undefined) {
	...
	var fss = "precision mediump float;uniform vec2 iResolution;uniform float iGlobalTime;uniform float iFrequency[512];uniform float iSync;\n"

	var examples = {
		"Choose Example": "",
	...
	var Shader = Demo.Shader = {
		...
		compile: function(e) {
			...
			gl.uniform1fv(Shader.iFrequency, new Float32Array(512));
