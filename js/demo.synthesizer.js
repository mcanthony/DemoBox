;(function(Demo, window, undefined) {
	...
	// Interfaces
	var ctx = document.querySelector("#synthesizer-canvas").getContext("2d");
	...
	// HTML-Elements
	var $view = document.querySelector(".synthesizer td");
	var $code = document.querySelector("#synthesizer-code");

	var $play = document.querySelector(".synthesizer .play-pause");
	var $reset = document.querySelector(".synthesizer .reset");
	var $run = document.querySelector(".synthesizer .run");
	var $time = document.querySelector(".synthesizer .time");
	...
	$code.addEventListener("keydown", function(e) {
		if (e.ctrlKey && [13, 83].indexOf(e.keyCode) != -1) {
			...
			location.hash = btoa(Demo.Synthesizer.value);
			e.preventDefault();
